...
//Type definition, if repeated definitions are displayed, just comment.
//QT needs to be defined
/*
...
//3. Define the data type of initialization CAN
...
/*------------------------------------------------Other Supplementary Functions and Data Structure Descriptions------------------------------------------------*/
